...
echo ""
echo "autoprov_cfg init Azure -mn r80dot40mgmt -tn Azure_VisualStudio_R80.40 -otp vpn12345 -ver R80.40 -po Standard -cn Azure -sb <Azure-Subscription> -at <Tenant-ID> -aci <Client-ID> -acs <Client-Secret>"
echo ""
echo "autoprov_cfg set template -tn Azure_VisualStudio_R80.40 -av -ab -ips"
echo ""
printf 'Once Manual task is complete, press [ENTER] to continue with SECUREME SCRIPT...'
read _
